...
<div class="container margin-top">
    ...
    <div class="row">
     ...
     <div class="row">
        ...
        <div class="col-md-4">
            <iframe src="/AnimCubeJS/cube.html?config=AnimCube.cfg&edit=0&buttonbar=1&colorscheme=ylllll&initmove=R' F' L F R F' L' F U R U' L' U R' U' L&move=z2 U R U' L' U R' U' L" frameborder="0" height="100%" width="100%"></iframe>
        </div>
    </div>
